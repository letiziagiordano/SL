...
L'idea di partenza era trovare la città europea più visitata nel mese di Gennaio e capirne i motivi. La scelta del mese è dovuta al suo particolare clima freddo e poichè include alcune festività come Capodanno o l'Epifania, abbiamo pensato potesse influenzare il turismo. 

Data la mancanza e/o l'incompatibilità dei dati acquisibili dalle varie nazioni, abbiamo pensato di restringere l'analisi all'Italia, cercando prima quale fosse la città più visitata e poi cercare di spiegare il motivo.

La motivazione che ci ha spinte a porci questa domanda è stata la curiosità di scoprire quale provincia italiana potesse essere la più visitata in questo mese e perchè, dato che viaggiare e scoprire nuove attività è una passiond che ci accomuna.

##Data

Il dataset principale è stato scaricato dalla banca dati dell'*http://dati.istat.it/*, sotto la voce *Servizi/Turismo/Movimento dei clienti negli esercizi ricettivi - dati mensili/Paese di origine*.

I dati sono suddivisi per Regione, Capoluogo di provincia e Provincia. Si è deciso di analizzare le Provincie perchè ritenute più informative per capire maggiormente i motivi dell'attrazione turistica.
...
Per rispondere alla domanda, si è eseguita una pulizia del dataset principale, quindi si sono rimosse osservazioni in eccesso e preso in considerazione il periodo temporale tra Gennaio 2008 e Gennaio 2016, in quanto prima del 2008 le osservazioni riguardavano solamente l'intera Italia e non le singole provincie; dopo il 2016 invece si sarebbe persa la comformità dei dati dato che nel 2017 si sono formate nuove provincie che inglobano alcune province più piccole esistenti. Si sono, inoltre, eliminate le osservazioni riguardanti gli arrivi e le presenze totali delle varie regione.
...
La domanda successiva è stata quella di controllare quale tipologia di alberghi è stata privilegiata, e quindi dopo una pulizia dei dati raccolti sempre dal sito *https://astat.provinz.bz.it/it/default.asp*:
...
Bolzano grazie all'ottima organizzazione delle attività legate al turismo invernale in particolare allo scii alpino, offre una qualità e un servizio che riesce ad attrarre tanti turisti nel mese di gennaio, che le permette di ottenere il primato di *provincia più visitata*, riuscendo a battere persino Roma, la capitale.
